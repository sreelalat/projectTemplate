    ...
    <div className="relative grid w-full items-center gap-1.5">
      <div className="relative">
        <input
          ...
          className={cn(
            "input-class  block w-full px-2.5  py-4 text-sm text-gray-900 bg-transparent border border-gray-300  rounded-lg appearance-none focus:outline-none focus:ring-0 focus:border-gray-600 peer disabled:cursor-not-allowed disabled:opacity-50",
            node.childClass
          )}
          ref={ref}
          {...props}
        ...
        <label
        htmlFor={node?.id + 500}
        className="absolute max-w-fit overflow-hidden text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 z-10 origin-[0] bg-white rounded-full px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 peer-focus:scale-75 peer-focus:-translate-y-6 left-2.5 whitespace-nowrap text-ellipsis"
